...
import { BalanceEffect } from '@/lib/database.types'

export function CreateAccountTypeDialog() {
  const t = useTranslations('settings.accountTypes.create')
      ...
      <DialogContent className="max-w-lg">
        <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-4 py-4">
            ...
            {/* Affects Balance */}
            <div className="space-y-2">
              <Label htmlFor="affects-balance">{t('affectsBalance')} *</Label>
              <Select
                value={affectsBalance}
                onValueChange={(value) => setAffectsBalance(value as BalanceEffect)}
              >
                <SelectTrigger id="affects-balance">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
